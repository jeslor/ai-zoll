...
**Status:** not yet implemented (placeholder package). Must be fully deterministic and
golden-tested — see `docs/plan/06-testing-strategy.md` and
`.claude/skills/add-deterministic-generator/SKILL.md`.
